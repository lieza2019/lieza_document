...
\begin{Lemma}{completeness on implementation.}
  ...
  \begin{Proof}
    ...
    \cup \Delta_t) = \phi$.
    Then we know $t \simeq t_h \wedge t_t$ for each case of
    $t' \in \mathpzc{Equ}(t)$ s.t.
    $t' = \{\} \wedge (t_h \wedge t_t)$ or
    $t' = \circ \wedge (t_h \wedge t_t)$ or
    $t' = t_h \wedge t_t$, from
    Lemma \ref{semiequivalency_on_implementation} with
    $(\text{\it RevealH-Cas}_{\{\}})$ or $(\text{\it RevealH-Cas}_\circ)$.
    Recalling the fact of
...
Similar to above, we can access other internal subterms in her cognition,
again.
\begin{verbatim}
