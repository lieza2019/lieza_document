  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            \dfrac{}{T \>\dot{\cong}\> \epsilon\ \text{\it s.t.}\
             T \neq \epsilon}\
            \quad \genfrac{}{}{0pt}{0}{}{\mathcal{R}_1 \,\text{\it is}\,
             \text{\it Any}.}
          }{
          ...
          \dfrac{
            \begin{array}{c}
              \Lambda_1 \vdash T'_{r_1} \>\dot{\blacktriangleright}\>
               \mathcal{R}_1 \cdots
                \Lambda_n \vdash T'_{r_n} \>\dot{\blacktriangleright}\>
                 \mathcal{R}_1\ \text{\it s.t.}\
                  \mathpzc{Dom}(\Lambda_j) \cap
                   \mathpzc{Dom}(\Lambda_k) = \phi  \\
              \text{\it where}\ T_{r_j} \>\dot{\cong}\> T'_{r_j}
               \text{\it s.t.} \!\begin{array}[t]{l}
                 T_{r_1} \!\bowtie_\wedge \cdots \bowtie_\wedge\! T_{r_n}
                  = T  \\
                 T,\, T'_{r_1} \!\bowtie_\wedge \cdots \bowtie_\wedge\!
                  T'_{r_n} \not\in \mathpzc{Dom}(\bigcup_{j=1}^n \Lambda_j )
               \end{array}
            \end{array}
          }{
            \bigl\{(T, T'_{r_1} \!\bowtie_\wedge \cdots \bowtie_\wedge\!
             T'_{r_n}, {\mathcal{R}_1}^*, \infty,
              \bigcup_{j=1}^n \Lambda_j ) \bigr\} \cup
               \bigcup_{j=1}^n \Lambda_j \vdash
        ...
        \left. \begin{array}{rl}
          ...
          \dfrac{
            \begin{array}{c}
              ...
              \text{\it where}\ T_{r_j} \>\dot{\cong}\> T'_{r_j}
               \text{\it s.t.} \!\begin{array}[t]{l}
                 T_{r_1} \!\bowtie_\vee \cdots \bowtie_\vee\! T_{r_n}
                  = T  \\
                 T,\, T'_{r_1} \!\bowtie_\vee \cdots \bowtie_\vee\! T'_{r_n}
                  \not\in \mathpzc{Dom}(\bigcup_{j=1}^n \Lambda_j )
               \end{array}
            \end{array}
          }{
            \bigl\{(T, T'_{r_1} \!\bowtie_\vee \cdots \bowtie_\vee\!
             T'_{r_n}, {\mathcal{R}_1}^\downarrow, \infty,
              \bigcup_{j=1}^n \Lambda_j ) \bigr\} \cup
               \bigcup_{j=1}^n \Lambda_j \vdash
                T \>\dot{\blacktriangleright}\> {\mathcal{R}_1}^\downarrow
          }  &  (\infty)
