  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{l}
        ...
        \left\{ \begin{array}{l}
          (T_2 \wedge \bot) \quad \text{\it if}\;\; T_1 = \bot  \\
          {\bigl(T_{11} \wedge (T_2 \wedge \bot) \bigr)}^{\mathpzc{id}(
           T_2 \wedge \bot)}
            \quad \text{\it if}\;\; T_1 = T_{11} \wedge \bot  \\
    ...
    \begin{array}{c}
      ...
      \begin{array}{l}
              ...
              \text{\it s.t } \!\!\begin{array}[t]{l}
                T'_{22} \neq \bot, \,
                 \mathpzc{id}(T'_{21} \wedge T'_{22}) =
                  \mathpzc{id}(T'_{22}) \\
                T'_{21} \wedge T'_{22}= \mathpzc{App}_{\{\}}\bigl(T'_2, T_3,
                 \mathpzc{id}(T'_{21} \wedge T'_{22}) \bigr)
              \end{array}
          }{
            T_1 \wedge T_2 \>\dot{\cong}\> (T'_1 \wedge T'_2) \wedge T_3
             \!\begin{array}[t]{rl}
               \text{\it where} &\!\!\! T'_2 = T'_{21} \wedge
                \mathpzc{Hd}_{\{\}}(T'_{22}),\, T_3 =
                 \mathpzc{Tl}_{\{\}}(T'_{22}) \\
                 \text{\it s.t.} &\!\!\! \!\!\!\begin{array}[t]{l}
                   \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_2)\
                    \text{\it on l.h.s.}  \\
        ...
        \mathpzc{Hd}_{\{\}}(T) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           \bot \quad \text{\it if}\;\; T = T_1 \wedge \bot\
            \text{\it s.t.}\ T_1 \neq \epsilon  \\
           (T_1 \wedge \bot)^{\mathpzc{id}(T)}
            \quad \text{\it if}\;\; T = T_1 \wedge (T_{21} \wedge \bot)\
             \text{\it s.t.}\ \mathpzc{id}(T) =
              \mathpzc{id}(T_{21} \wedge \bot)  \\
            \bigl(T_1 \wedge \mathpzc{Hd}_{\{\}}(T_{21} \wedge T_{22})
             \bigr)^{\mathpzc{id}(T_{21} \wedge T_{22})}
        ...
        \mathpzc{Tl}_{\{\}}(T) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           T_1 \quad \text{\it if}\;\; T = T_1 \wedge \bot\
            \text{\it s.t.}\ T_1 \neq \epsilon  \\
           T_{21} \quad \text{\it if}\;\; T = T_1 \wedge (T_{21} \wedge
            \bot)\ \text{\it s.t.}\ \mathpzc{id}(T) =
             \mathpzc{id}(T_{21} \wedge \bot)  \\
            \mathpzc{Tl}_{\{\}}(T_{21} \wedge T_{22})
             \quad \!\!\begin{array}[t]{l}
               \text{\it if}\;\; T = T_1 \wedge (T_{21} \wedge T_{22}),\;
                T_{22} \neq \bot  \\
               \text{\it s.t.}\
