  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \dfrac{
          T \cong T'\
          \text{\it s.t the last applied rule isn't}\
          (\text{\it Symmetry-inter})
        }{
          T' \cong T
        }  &  (\text{\it Symmetry-inter})
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          T_1 \wedge T_2 \cong T'' \ \text{\it s.t.}\
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          T \cong T' \wedge \bot\ \text{\it s.t.}\
           \mathpzc{id}(T' \wedge \bot) = \mathpzc{id}(T') 
        }  &  \text{\it (Link-Cat0}_1\text{\it -inter)}
      \end{array}  \\
      \\
      \begin{array}{rl}
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          T \cong \bot \wedge T'\ \text{\it s.t.}\
           \mathpzc{id}(\bot \wedge T') = \mathpzc{id}(T')
        }  &  \text{\it (Link-Cat1}_1\text{\it -inter)}
      \end{array}  \\
      \\
    ...
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          T \cong \bot \vee T'\ \text{\it s.t.}\
           \mathpzc{id}(\bot \vee T') = \mathpzc{id}(T')
        }  &  \text{\it (Link-Dup}_1\text{\it -inter)}
      \end{array}  \\
      \\
      \begin{array}{rl}
  ...
  \begin{displaymath}
    \begin{array}{c}
          ...
          \begin{array}{c}
            \Lambda_1 \vdash T_1 \blacktriangleright \mathcal{R}_1
             \quad \Lambda_2 \vdash T_2 \blacktriangleright
              \mathcal{R}_2 \quad \text{\it s.t.}\
               \mathpzc{Dom}(\Lambda_1) \cap \mathpzc{Dom}(\Lambda_2)
                = \phi \\
            \text{\it where}\ T \cong T_1 \wedge T_2\
            ...
            \Lambda_1 \vdash T_1 \blacktriangleright \mathcal{R}_1
             \quad \Lambda_2 \vdash T_2 \blacktriangleright
              \mathcal{R}_2 \quad \text{\it s.t.}\
               \mathpzc{Dom}(\Lambda_1) \cap \mathpzc{Dom}(\Lambda_2)
                = \phi  \\
            \text{\it where}\ T \cong T_1 \vee T_2\
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            \dfrac{}{T \cong \epsilon\ \text{\it s.t.}\
             T \neq \epsilon}\
            \quad \genfrac{}{}{0pt}{0}{}{\mathcal{R}_1 \,\text{\it is}\,
             \text{\it Any}.}
          }{
          ...
          \\
          \dfrac{
            \Lambda' \vdash T' \blacktriangleright \mathcal{R}_1\
             \text{\it where}\ T \cong T'\ \text{\it s.t.}\
          ...
          \dfrac{
            \begin{array}{c}
              \Lambda_h \vdash T_h \blacktriangleright
               \mathcal{R}_1 
              \quad \Lambda_t \vdash T_t \blacktriangleright
               {\mathcal{R}_1}^*\ \text{\it s.t.}\
                \mathpzc{Dom}(\Lambda_h) \cap
                 \mathpzc{Dom}(\Lambda_t) = \phi  \\
              \text{\it where}\ T \cong T_h \wedge T_t\
               \text{\it s.t.} \!\begin{array}[t]{l}
              ...
              \quad \Lambda_t \vdash T_t \blacktriangleright
               {\mathcal{R}_1}^+\ \text{\it s.t.}\
                \mathpzc{Dom}(\Lambda_h) \cap \mathpzc{Dom}(\Lambda_t)
                 = \phi  \\
              \text{\it where}\ T \cong T_t \wedge T_h\
               \text{\it s.t.} \!\begin{array}[t]{l}
  ...
  \begin{displaymath}
    \begin{array}{c}
            ...
            \begin{array}{c}
              ...
              \quad \Lambda_t \vdash T_t \blacktriangleright
               {\mathcal{R}_1}^\downarrow\ \text{\it s.t.}\
                \mathpzc{Dom}(\Lambda_h) \cap \mathpzc{Dom}(\Lambda_t)
                 = \phi  \\
              \text{\it where}\ T \cong T_t \vee T_h\
               \text{\it s.t.} \!\begin{array}[t]{l}
      ...
      \begin{array}{rl}
        \left.\begin{array}{rl}
          \dfrac{
            \Lambda_1 \vdash T' \blacktriangleright \mathcal{R}_1\
             \text{\it where}\ T \cong T' \ \text{\it s.t.}\
          ...
          \\
          \dfrac{
            \Lambda_2 \vdash T' \blacktriangleright \mathcal{R}_2\
             \text{\it where}\ T \cong T' \ \text{\it s.t.}\
      ...
      \begin{array}{rl}
        \left.\begin{array}{rl}
          ...
          \\
          \dfrac{
            \Lambda_2 \vdash T' \blacktriangleright
             \mathcal{R}_2\ \text{\it where}\
              T \cong T' \ \text{\it s.t.}\
               T \not\in \mathpzc{Dom}(\Lambda_2)
          }{
            \bigl\{(T, T',{\mathcal{R}_1}^* \vee \mathcal{R}_2, \vee,
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            \Lambda_L \vdash T' \blacktriangleright \mathcal{R}_1\
             \text{\it where}\ T \cong T'\ 
          ...
          \dfrac{
            ...
            \quad \Lambda_R \vdash T' \blacktriangleright
             \mathcal{R}_2\ \text{\it where}\
              T \cong T'\ \text{\it s.t.}\
    ...
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            \Lambda' \vdash T' \blacktriangleright \mathcal{R}_1\
             \text{\it where}\ T \>\dot{\cong}\> T' \wedge T_\epsilon\
              \text{\it s.t.}\ T_\epsilon \in \mathcal{E},
               T \not\in \mathpzc{Dom}(\Delta')
          }{
          ...
          \dfrac{
            \Lambda' \vdash T' \blacktriangleright \mathcal{R}_1\
             \text{\it where}\ T \>\dot{\cong}\> T_\epsilon \wedge T' \
              \text{\it s.t.}\ T_\epsilon \in \mathcal{E},
               T \not\in \mathpzc{Dom}(\Delta')
          }{
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            \Lambda' \vdash T' \blacktriangleright \mathcal{R}_1\
             \text{\it where}\ T \>\dot{\cong}\> T' \vee T_\epsilon\
              \text{\it s.t.}\ T_\epsilon \in \mathcal{E},
               T \not\in \mathpzc{Dom}(\Delta')
          }{
          ...
          \dfrac{
            \Lambda' \vdash T' \blacktriangleright \mathcal{R}_1\
             \text{\it where}\ T \>\dot{\cong}\> T_\epsilon \vee T' \
              \text{\it s.t.}\ T_\epsilon \in \mathcal{E},
               T \not\in \mathpzc{Dom}(\Delta')
          }{
...
\label{equality_on_INTERNALS}
  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \dfrac{T_1 \cong T_1' \quad T_2 \cong T_2'}{
          T_1 \!\wedge\! T_2 \cong T_1' \!\wedge\! T_2'\ \text{\it s.t.}
           \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \wedge T_2) \neq \mathpzc{id}(T_1),\,
              \mathpzc{id}(T_2)\ \text{\it on l.h.s.}  \\
             \mathpzc{id}(T'_1 \wedge T'_2) \neq \mathpzc{id}(T'_1),\,
              \mathpzc{id}(T'_2)\ \text{\it on r.h.s.}
          \end{array}
      ...
      \begin{array}{rl}
        \dfrac{T_1 \cong T_1' \quad T_2 \cong T_2'}{
          T_1 \!\vee\! T_2 \cong T_1' \!\vee\! T_2'\ \text{\it s.t.}
           \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \vee T_2) \neq \mathpzc{id}(T_1),\,
              \mathpzc{id}(T_2)\ \text{\it on l.h.s.}  \\
             \mathpzc{id}(T'_1 \vee T'_2) \neq \mathpzc{id}(T'_1),\,
              \mathpzc{id}(T'_2)\ \text{\it on r.h.s.}
          \end{array}
      ...
      \begin{array}{rl}
        \dfrac{
          T_1 \cong T'_1
           \quad T_2 \cong T'_2\ \text{\it where}\
            T'_2 \neq T'_{21} \wedge \bot\ \text{\it nor}\
             T'_{21} \wedge T'_{22}\
              \text{\it s.t.}\ \mathpzc{id}(T'_{21} \wedge T'_{22}) =
               \mathpzc{id}(T'_{22})
        }{
          T_1 \wedge T_2 \cong
           T'_1 \wedge (T'_2 \wedge \bot)\ \text{\it s.t.}
            \!\begin{array}[t]{l}
              \mathpzc{id}(T_1 \wedge T_2) \neq \mathpzc{id}(T_1),\,
               \mathpzc{id}(T_2)\ \text{\it on l.h.s.}  \\
              \mathpzc{id}\bigl(T'_1 \wedge (T'_2 \wedge \bot) \bigr) =
               \mathpzc{id}(T'_2 \wedge \bot)\ \text{\it on r.h.s.}
            \end{array}
        }  &  \text{\it (LinkH-Cat0}_1\text{\it -nucls)}
      \end{array} \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_2 \cong T'_2
           \quad T_1 \cong T'_1\ \text{\it where}\
            T'_1 \neq T'_{11} \wedge \bot\ \text{\it nor}\
             T'_{11} \wedge T'_{12}\
              \text{\it s.t.}\ \mathpzc{id}(T'_{11} \wedge T'_{12}) =
               \mathpzc{id}(T'_{12})
        }{
          T_1 \wedge T_2 \cong
           T'_1 \wedge (T'_2 \wedge \bot)\ \text{\it s.t.}
            \!\begin{array}[t]{l}
              ...
              \mathpzc{id}\bigl(T'_1 \wedge (T'_2 \wedge \bot) \bigr) =
               \mathpzc{id}(T'_2 \wedge \bot)\ \text{\it on r.h.s.}
            \end{array}
        }  &  \text{\it (LinkT-Cat0}_1\text{\it -nucls)}
      \end{array} \\
      \\
           ...
           T'_1 \wedge (T_{21} \wedge T_{22})\ \text{\it s.t.}
            \!\begin{array}[t]{l}
              \mathpzc{id}(T_1 \wedge T_2) \neq \mathpzc{id}(T_1),\,
               \mathpzc{id}(T_2)\ \text{\it on l.h.s.}  \\
              \mathpzc{id}\bigl(T'_1 \wedge (T_{21} \wedge T_{22}) \bigr) =
               \mathpzc{id}(T_{21} \wedge T_{22})\ \text{\it on r.h.s.}
            \end{array}
      ...
      \begin{array}{l}
        \begin{array}{rl}
          \dfrac{
            ...
            T_1 \wedge T_2 \cong \mathpzc{App}_{\{\}}(
             T_{11} \wedge T_{12}, T'_2 )\ \text{\it s.t.}\
              \mathpzc{id}(T_1 \wedge T_2) \neq \mathpzc{id}(T_1),\,
               \mathpzc{id}(T_2)\ \text{\it on l.h.s.}
        ...
        \left\{ \begin{array}{l}
          T_2 \quad \text{\it if}\;\; T_1 = \epsilon \wedge \bot  \\
          {(T_{11} \wedge T_2)}^{\mathpzc{id}(T_2)}
           \quad \text{\it if}\;\; T_1 = T_{11} \wedge \bot\
            \text{\it s.t.}\ \mathpzc{id}(T_{11}) \neq \mathpzc{id}(T_{2}) \\
          {\bigl(T_{11} \wedge \mathpzc{App}_{\{\}}(T_{12}, T_2)
           \bigr)}^{\mathpzc{id}\bigl(\mathpzc{App}_{\{\}}(T_{12}, T_2)
            \bigr)} \quad \!\!\begin{array}[t]{l}
              \text{\it if}\;\; T_1 = T_{11} \wedge T_{12},\;
               T_{12} \neq \bot  \\
              \text{\it s.t.}\ \mathpzc{id}(T_1) = \mathpzc{id}(T_{12})
            \end{array}  \\
          {(T_1 \wedge T_2)}^{\mathpzc{id}(T_2)} \quad \text{\it otherwise}
        \end{array} \right.
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          T_1 \wedge \bot \>\dot{\cong}\> T'_1
        }  &  \text{\it (Unlk-Cat0}_1\text{\it -nucls)}
      \end{array}
  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \dfrac{
          T_1 \>\dot{\cong}\> T'_1
           \quad T_2 \>\dot{\cong}\> T'_2 \ \text{\it where}\
            T'_2 = T'_{21} \wedge T'_{22}\ \text{\it s.t.}\
             \mathpzc{id}(T'_2) = \mathpzc{id}(T'_{22})\
              \text{\it if}\;\; T'_{22} \neq \bot
        }{
          T_1 \wedge T_2 \>\dot{\cong}\> T'_1 \wedge T'_2\
           \text{\it s.t.} \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_2)\
              \text{\it on l.h.s.}  \\
             \mathpzc{id}(T'_1 \wedge T'_2) \neq \mathpzc{id}(T'_2)\
              \text{\it on r.h.s.}
           \end{array} 
        }  &  \text{\it (UnlkH-Cat0}_\infty\text{\it -nucls)}
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_1 \>\dot{\cong}\> T'_1
           \quad T_2 \>\dot{\cong}\> T'_{21} \wedge \bot
        }{
          T_1 \wedge T_2 \>\dot{\cong}\> (T'_1 \wedge \bot) \wedge T'_{21}\
           \text{\it s.t.} \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_2)\
              \text{\it on l.h.s.}  \\
             \mathpzc{id}\bigl((T'_1 \wedge \bot) \wedge T'_{21} \bigr)
              \neq \mathpzc{id}(T'_1 \wedge \bot)\ \text{\it on r.h.s.}
           \end{array} 
        }  &  \text{\it (UnlkT-Cat0}_2\text{\it -nucls)}
      \end{array}  \\
      \\
      ...
      \begin{array}{l}
        \begin{array}{rl}
          \dfrac{
            T_1 \>\dot{\cong}\> T'_1
             \quad T_2 \>\dot{\cong}\> T'_{21} \wedge T'_{22}\
              \text{\it s.t } \!\!\begin{array}[t]{l}
                T'_{22} \neq \bot, \,
                 \mathpzc{id}(T'_{21} \wedge T'_{22}) =
                  \mathpzc{id}(T'_{22}) \\
                T'_{21} \wedge T'_{22}= \mathpzc{App}_{\{\}}(T'_2, T_3)
              \end{array}
          }{
            T_1 \wedge T_2 \>\dot{\cong}\> (T'_1 \wedge T'_2) \wedge T_3
             \!\begin{array}[t]{rl}
               \text{\it where} &\!\!\! T'_2 = T'_{21} \wedge T''_{22},\,
                T''_{22} \in \mathpzc{Hd}_{\{\}}(T'_{22}),\,
                T_3 \in \mathpzc{Tl}_{\{\}}(T'_{22}) \\
                 \text{\it s.t.} &\!\!\! \!\!\!\begin{array}[t]{l}
                   \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_2)\
                    \text{\it on l.h.s.}  \\
                   \mathpzc{id}(T'_2) = \left\{\begin{array}[c]{l}
                     \!\!\mathpzc{id}(T'_{21} \wedge T'_{22})\;\;
                      \text{\it if}\ \mathpzc{Hd}_{\{\}}(T'_{22}) = \bot \\
                     \!\!\mathpzc{id}\bigl(\mathpzc{Hd}_{\{\}}(T'_{22})
                      \bigr)\;\; \text{\it o.w.}
                   \end{array}\right.  \\
                   \mathpzc{id}(T'_1 \wedge T'_2) = \mathpzc{id}(T'_2)  \\
                   \mathpzc{id}\bigl((T'_1 \wedge T'_2) \wedge T_3 \bigr)
                    \neq \mathpzc{id}(T_3)\ \text{\it on r.h.s.}
               \end{array}
             \end{array}
          }  &  \!\! \text{\it (UnlkT-Cat0}_\infty\text{\it -nucls)}
        \end{array}  \\
        \text{\it where}  \\
        \mathpzc{Hd}_{\{\}}(T) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           \{\bot\} \quad \text{\it if}\;\; T = T_1 \wedge \bot\
            \text{\it s.t.}\ T_1 \neq \epsilon  \\
           \bigl\{\bot, (T_1 \wedge \bot)^{\mathpzc{id}(T)} \bigr\}
            \quad \text{\it if}\;\; T = T_1 \wedge (T_{21} \wedge \bot)\
             \text{\it s.t.}\ \mathpzc{id}(T) =
              \mathpzc{id}(T_{21} \wedge \bot)  \\
            \bigl\{\bot, {(T_1 \wedge T')}^{\mathpzc{id}(T_{21} \wedge
             T_{22})} \mid {T'} \in \mathpzc{Hd}_{\{\}}(T_{21}
              \wedge T_{22}) \bigr\}
               \quad \text{\it if}\;\; T = T_1 \wedge (T_{21} \wedge
                T_{22}),\; T_{22} \neq \bot  \\
                 \qquad \text{\it s.t.}\ \mathpzc{id}(T) =
                  \mathpzc{id}(T_{21} \wedge T_{22}),\; \mathpzc{id}(T_{21}
                   \wedge T_{22}) = \mathpzc{id}(T_{22}) \\ 
            \{T\}  \quad \text{\it otherwise}
         \end{array} \right. \vspace{3pt}  \\
        \mathpzc{Tl}_{\{\}}(T) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           \bigl\{T, (T_2 \wedge \bot)^{\mathpzc{id}(T_2 \wedge \bot)}
            \bigr\} \quad \text{\it if}\;\; T = T_1 \wedge (T_2 \wedge \bot)\
             \text{\it s.t.}\ \mathpzc{id}(T) = \mathpzc{id}(T_2 \wedge
              \bot)  \\
            \{T\} \cup \mathpzc{Tl}_{\{\}}(T_{21} \wedge T_{22})
             \quad \!\!\begin{array}[t]{l}
               \text{\it if}\;\; T = T_1 \wedge (T_{21} \wedge T_{22}),\;
                T_{22} \neq \bot  \\
               \text{\it s.t.}\
                \mathpzc{id}(T) = \mathpzc{id}(T_{21} \wedge T_{22}),\;
                 \mathpzc{id}(T_{21} \wedge T_{22}) = \mathpzc{id}(T_{22})
             \end{array}  \\
            \{T\}  \quad \text{\it otherwise}
         \end{array} \right.
      \end{array}  \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_1 \cong T'_1
           \quad T_2 \cong T'_2\ \text{\it where}\
            T'_2 \neq \bot \wedge T'_{22}\ \text{\it nor}\
             T'_{21} \wedge T'_{22}\
              \text{\it s.t.}\ \mathpzc{id}(T'_{21} \wedge T'_{22}) =
               \mathpzc{id}(T'_{21})
        }{
          T_1 \wedge T_2 \cong
           (\bot \wedge T'_2) \wedge T'_1\ \text{\it s.t.}
            \!\begin{array}[t]{l}
              \mathpzc{id}(T_1 \wedge T_2) \neq \mathpzc{id}(T_1),\,
               \mathpzc{id}(T_2)\ \text{\it on l.h.s.}  \\
              \mathpzc{id}\bigl((\bot \wedge T'_2) \wedge T'_1 \bigr) =
               \mathpzc{id}(\bot \wedge T'_2)\ \text{\it on r.h.s.}
            \end{array}
        }  &  \text{\it (LinkH-Cat1}_1\text{\it -nucls)}
      \end{array} \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_2 \cong T'_2
           \quad T_1 \cong T'_1\ \text{\it where}\
            T'_1 \neq \bot \wedge T'_{12}\ \text{\it nor}\
             T'_{11} \wedge T'_{12}\
              \text{\it s.t.}\ \mathpzc{id}(T'_{11} \wedge T'_{12}) =
               \mathpzc{id}(T'_{11})
        }{
           ...
           (\bot \wedge T'_2) \wedge T'_1\ \text{\it s.t.}
            \!\begin{array}[t]{l}
              ...
              \mathpzc{id}\bigl((\bot \wedge T'_2) \wedge T'_1 \bigr) =
               \mathpzc{id}(\bot \wedge T'_2)\ \text{\it on r.h.s.}
            \end{array}
        }  &  \text{\it (LinkT-Cat1}_1\text{\it -nucls)}
      \end{array} \\
      \\
  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{l}
        ...
        \mathpzc{App}_{[\,]}(T_1, T_2) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           (\bot \wedge T_2) \quad \text{\it if}\;\; T_1 = \bot  \\
           {\bigl((\bot \wedge T_2) \wedge T_{11} \bigr)}^{\mathpzc{id}(
            \bot \wedge T_2)}
             \quad \text{\it if}\;\; T_1 = \bot \wedge T_{11}  \\
           {\bigl(\mathpzc{App}_{[\,]}(T_{12}, T_2) \wedge T_{11}
            \bigr)}^{\mathpzc{id}\bigl(\mathpzc{App}_{[\,]}(T_{12}, T_2)
             \bigr)} \quad \!\!\begin{array}[t]{l}
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          \bot \wedge T_1 \>\dot{\cong}\> T'_1
        }  &  \text{\it (Unlk-Cat1}_1\text{\it -nucls)}
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_2 \>\dot{\cong}\> T'_2
           \quad T_1 \>\dot{\cong}\> T'_1 \ \text{\it where}\
            T'_1 = T'_{11} \wedge T'_{12}\ \text{\it s.t.}\
             \mathpzc{id}(T'_1) = \mathpzc{id}(T'_{11})\
              \text{\it if}\;\; T'_{11} \neq \bot
        }{
          T_1 \wedge T_2 \>\dot{\cong}\> T'_2 \wedge T'_1\
           \text{\it s.t.} \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_1)\
              \text{\it on l.h.s.}  \\
             \mathpzc{id}(T'_2 \wedge T'_1) \neq \mathpzc{id}(T'_2)\
              \text{\it on r.h.s.}
           \end{array} 
        }  &  \text{\it (UnlkH-Cat1}_\infty\text{\it -nucls)}
      \end{array} \\
      \\
      
      \begin{array}{rl}
        \dfrac{
          T_1 \>\dot{\cong}\> \bot \wedge T'_{12}
           \quad T_2 \>\dot{\cong}\> T'_2
        }{
          T_1 \wedge T_2 \>\dot{\cong}\> (\bot \wedge T'_2) \wedge T'_{12}\
           \text{\it s.t.} \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_1)\
              \text{\it on l.h.s.}  \\
             \mathpzc{id}\bigl((\bot \wedge T'_2) \wedge T'_{12} \bigr)
              \neq \mathpzc{id}(\bot \wedge T'_2)\ \text{\it on r.h.s.}
           \end{array} 
        }  &  \text{\it (UnlkT-Cat1}_2\text{\it -nucls)}
      \end{array}  \\
      \\
      ...
      \begin{array}{l}
        \begin{array}{rl}
          \dfrac{
            T_2 \>\dot{\cong}\> T'_2
             \quad T_1 \>\dot{\cong}\> T'_{11} \wedge T'_{12}\
              \text{\it s.t } \!\!\begin{array}[t]{l}
                T'_{11} \neq \bot, \,
                 \mathpzc{id}(T'_{11} \wedge T'_{12}) =
                  \mathpzc{id}(T'_{11}) \\
                T'_{11} \wedge T'_{12}= \mathpzc{App}_{[\,]}\bigl(T'_1, T_3,
                 \mathpzc{id}(T'_{11} \wedge T'_{12}) \bigr)
              \end{array}
          }{
            T_1 \wedge T_2 \>\dot{\cong}\> (T'_1 \wedge T'_2) \wedge T_3
             \!\begin{array}[t]{rl}
               \text{\it where} &\!\!\! T'_1 = \mathpzc{Hd}_{[\,]}(T'_{11})
                \wedge T'_{12},\, T_3 = \mathpzc{Tl}_{[\,]}(T'_{11})  \\
               \text{\it s.t.} &\!\!\! \!\!\!\begin{array}[t]{l}
                 \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_1)\
                  \text{\it on l.h.s.}  \\
                 \mathpzc{id}(T'_1) = \left\{\begin{array}[c]{l}
                   \!\!\mathpzc{id}(T'_{11} \wedge T'_{12})\;\;
                    \text{\it if}\ \mathpzc{Hd}_{[\,]}(T'_{11}) = \bot  \\
                   \!\!\mathpzc{id}\bigl(\mathpzc{Hd}_{[\,]}(T'_{11})
                    \bigr)\;\; \text{\it o.w.}
                 \end{array}\right.  \\
                 \mathpzc{id}(T'_1 \wedge T'_2) = \mathpzc{id}(T'_1)  \\
                 \mathpzc{id}\bigl((T'_1 \wedge T'_2) \wedge T_3 \bigr)
                  \neq \mathpzc{id}(T'_1 \wedge T'_2)\ \text{\it on r.h.s.}
               \end{array}
             \end{array}
          }  &  \text{\it (UnlkT-Cat1}_\infty\text{\it -nucls)}
        \end{array}  \\
        \text{\it where}  \\
        \mathpzc{Hd}_{[\,]}(T) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           \bot \quad \text{\it if}\;\; T = \bot \wedge T_2  \\
           (\bot \wedge T_2)^{\mathpzc{id}(T)}
            \quad \text{\it if}\;\; T = (\bot \wedge T_{12}) \wedge T_2\
             \text{\it s.t.}\ \mathpzc{id}(T) =
              \mathpzc{id}(\bot \wedge T_{12})  \\
            \bigl(\mathpzc{Hd}_{[\,]}(T_{11} \wedge T_{12}) \wedge T_2
             \bigr)^{\mathpzc{id}(T_{11} \wedge T_{12})}
              \quad \!\!\begin{array}[t]{l}
                \text{\it if}\;\; T = (T_{11} \wedge T_{12}) \wedge T_2,\;
                 T_{11} \neq \bot  \\
                \text{\it s.t.}\ 
                 \mathpzc{id}(T) = \mathpzc{id}(T_{11} \wedge T_{12}),\;
                  \mathpzc{id}(T_{11} \wedge T_{12}) = \mathpzc{id}(T_{11})
              \end{array}  \\
            T  \quad \text{\it otherwise}
         \end{array} \right. \vspace{3pt}  \\
        \mathpzc{Tl}_{[\,]}(T) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           T_2 \quad \text{\it if}\;\; T = \bot \wedge T_2  \\
           T_{12} \quad \text{\it if}\;\; T = (\bot \wedge T_{12}) \wedge
            T_2\ \text{\it s.t.}\ \mathpzc{id}(T) = \mathpzc{id}(\bot \wedge
             T_{12})  \\
           \mathpzc{Tl}_{[\,]}(T_{11} \wedge T_{12})
            \quad \!\!\begin{array}[t]{l}
              \text{\it if}\;\; T = (T_{11} \wedge T_{12}) \wedge T_2,\;
               T_{11} \neq \bot  \\
              \text{\it s.t.}\
    ...
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \dfrac{
          T_1 \cong T'_1
           \quad T_2 \cong T'_2\ \text{\it where}\
            T'_2 \neq \bot \vee T'_{22}\ \text{\it nor}\
             T'_{21} \vee T'_{22}\
              \text{\it s.t.}\ \mathpzc{id}(T'_{21} \vee T'_{22}) =
               \mathpzc{id}(T'_{21})
        }{
          T_1 \vee T_2 \cong
           (\bot \vee T'_2) \vee T'_1\ \text{\it s.t.}
            \!\begin{array}[t]{l}
              \mathpzc{id}(T_1 \vee T_2) \neq \mathpzc{id}(T_1),\,
               \mathpzc{id}(T_2)\ \text{\it on l.h.s.}  \\
              \mathpzc{id}\bigl((\bot \vee T'_2) \vee T'_1 \bigr) =
               \mathpzc{id}(\bot \vee T'_2)\ \text{\it on r.h.s.}
            \end{array}
        }  &  \text{\it (LinkH-Dup}_1\text{\it -nucls)}
      \end{array} \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_2 \cong T'_2
           \quad T_1 \cong T'_1\ \text{\it where}\
            T'_1 \neq \bot \vee T'_{12}\ \text{\it nor}\
             T'_{11} \vee T'_{12}\
              \text{\it s.t.}\ \mathpzc{id}(T'_{11} \vee T'_{12}) =
               \mathpzc{id}(T'_{11})
        }{
          T_1 \vee T_2 \cong
           (\bot \vee T'_2) \vee T'_1\ \text{\it s.t.}
            \!\begin{array}[t]{l}
              ...
              \mathpzc{id}\bigl((\bot \vee T'_2) \vee T'_1 \bigr) =
               \mathpzc{id}(\bot \vee T'_2)\ \text{\it on r.h.s.}
            \end{array}
        }  &  \text{\it (LinkT-Dup}_1\text{\it -nucls)}
      \end{array} \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          T_1 \vee T_2 \cong (T_{21} \vee T_{22}) \vee T'_1\ \text{\it s.t.}
           \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \vee T_2) \neq \mathpzc{id}(T_1),\,
              \mathpzc{id}(T_2)\ \text{\it on l.h.s.}  \\
             \mathpzc{id}\bigl((T_{21} \vee T_{22}) \vee T'_1 \bigr) =
              \mathpzc{id}(T_{21} \vee T_{22})\ \text{\it on r.h.s.}
           \end{array}
      ...
      \begin{array}{l}
        \begin{array}{rl}
          \dfrac{
            ...
            T_1 \vee T_2 \cong \mathpzc{App}_{\langle\rangle}(
             T_{11} \vee T_{12}, T'_2 )\ \text{\it s.t.}\
              \mathpzc{id}(T_1 \vee T_2) \neq \mathpzc{id}(T_1),\,
               \mathpzc{id}(T_2)\ \text{\it on l.h.s.}
        ...
        \,\stackrel{\mathrm{def}}{:=}\, \left\{ \begin{array}{l}
          (\bot \vee T_2) \quad \text{\it if}\;\; T_1 = \bot  \\
          {\bigl((\bot \vee T_2) \vee T_{11} \bigr)}^{\mathpzc{id}(
           \bot \vee T_2)}
            \quad \text{\it if}\;\; T_1 = \bot \vee T_{11}  \\
          {\bigl(\mathpzc{App}_{\langle\rangle}(T_{12}, T_2) \vee T_{11}
           \bigr)}^{\mathpzc{id}\bigl(\mathpzc{App}_{\langle\rangle}(
            T_{12}, T_2) \bigr)} \quad \!\!\begin{array}[t]{l}
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          \bot \vee T_1 \>\dot{\cong}\> T'_1
        }  &  \text{\it (Unlk-Dup}_1\text{\it -nucls)}
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_2 \>\dot{\cong}\> T'_2
           \quad T_1 \>\dot{\cong}\> T'_1 \ \text{\it where}\
            T'_1 = T'_{11} \vee T'_{12}\ \text{\it s.t.}\
             \mathpzc{id}(T'_1) = \mathpzc{id}(T'_{11})\
              \text{\it if}\;\; T'_{11} \neq \bot
        }{
          T_1 \vee T_2 \>\dot{\cong}\> T'_2 \vee T'_1\
           \text{\it s.t.} \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \vee T_2) = \mathpzc{id}(T_1)\
              \text{\it on l.h.s.}  \\
             \mathpzc{id}(T'_2 \vee T'_1) \neq \mathpzc{id}(T'_2)\
              \text{\it on r.h.s.}
           \end{array} 
        }  &  \text{\it (UnlkH-Dup}_\infty\text{\it -nucls)}
      \end{array} \\
      \\
      
      \begin{array}{rl}
        \dfrac{
          T_1 \>\dot{\cong}\> \bot \vee T'_{12}
           \quad T_2 \>\dot{\cong}\> T'_2
        }{
          T_1 \vee T_2 \>\dot{\cong}\> (\bot \vee T'_2) \vee T'_{12}\
           \text{\it s.t.} \!\begin{array}[t]{l}
             \mathpzc{id}(T_1 \vee T_2) = \mathpzc{id}(T_1)\
              \text{\it on l.h.s.}  \\
             \mathpzc{id}\bigl((\bot \vee T'_2) \vee T'_{12} \bigr)
              \neq \mathpzc{id}(\bot \vee T'_2)\ \text{\it on r.h.s.}
           \end{array} 
        }  &  \text{\it (UnlkT-Dup}_2\text{\it -nucls)}
      \end{array}
    ...
    \begin{array}{c}
      ...
      \begin{array}{l}
        \begin{array}{rl}
          \dfrac{
            T_2 \>\dot{\cong}\> T'_2
             \quad T_1 \>\dot{\cong}\> T'_{11} \vee T'_{12}\
              \text{\it s.t } \!\!\begin{array}[t]{l}
                T'_{11} \neq \bot, \,
                 \mathpzc{id}(T'_{11} \vee T'_{12}) =
                  \mathpzc{id}(T'_{11}) \\
                T'_{11} \vee T'_{12}=
                 \mathpzc{App}_{\langle\rangle}\bigl(T'_1, T_3,
                  \mathpzc{id}(T'_{11} \vee T'_{12}) \bigr)
              \end{array}
          }{
            T_1 \vee T_2 \>\dot{\cong}\> (T'_1 \vee T'_2) \vee T_3
             \!\begin{array}[t]{rl}
               \text{\it where} &\!\!\! T'_1 =
                \mathpzc{Hd}_{\langle\rangle}(T'_{11})
               \vee T'_{12},\, T_3 =
                \mathpzc{Tl}_{\langle\rangle}(T'_{11})  \\
               \text{\it s.t.} &\!\!\! \!\!\!\begin{array}[t]{l}
                 \mathpzc{id}(T_1 \vee T_2) = \mathpzc{id}(T_1)\
                  \text{\it on l.h.s.}  \\
                 \mathpzc{id}(T'_1) = \left\{\begin{array}[c]{l}
                   \!\!\mathpzc{id}(T'_{11} \vee T'_{12})\;\;
                    \text{\it if}\ \mathpzc{Hd}_{\langle\rangle}(T'_{11}) =
                     \bot  \\
                   \!\!\mathpzc{id}\bigl(\mathpzc{Hd}_{\langle\rangle}(
                    T'_{11})\bigr)\;\; \text{\it o.w.}
                 \end{array}\right.  \\
                 \mathpzc{id}(T'_1 \vee T'_2) = \mathpzc{id}(T'_1)  \\
                 \mathpzc{id}\bigl((T'_1 \vee T'_2) \vee T_3 \bigr)
                  \neq \mathpzc{id}(T'_1 \vee T'_2)\ \text{\it on r.h.s.}
               \end{array}
             \end{array}
          }  &  \text{\it (UnlkT-Dup}_\infty\text{\it -nucls)}
        \end{array}  \\
        \text{\it where}  \\
        \mathpzc{Hd}_{\langle\rangle}(T) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           \bot \quad \text{\it if}\;\; T = \bot \vee T_2  \\
           (\bot \vee T_2)^{\mathpzc{id}(T)}
            \quad \text{\it if}\;\; T = (\bot \vee T_{12}) \vee T_2\
             \text{\it s.t.}\ \mathpzc{id}(T) =
              \mathpzc{id}(\bot \vee T_{12})  \\
            \bigl(\mathpzc{Hd}_{\langle\rangle}(T_{11} \vee T_{12}) \vee T_2
             \bigr)^{\mathpzc{id}(T_{11} \vee T_{12})}
              \quad \!\!\begin{array}[t]{l}
                \text{\it if}\;\; T = (T_{11} \vee T_{12}) \vee T_2,\;
                 T_{11} \neq \bot  \\
                \text{\it s.t.}\ 
                 \mathpzc{id}(T) = \mathpzc{id}(T_{11} \vee T_{12}),\;
                  \mathpzc{id}(T_{11} \vee T_{12}) = \mathpzc{id}(T_{11})
              \end{array}  \\
            T  \quad \text{\it otherwise}
         \end{array} \right. \vspace{3pt}  \\
        \mathpzc{Tl}_{\langle\rangle}(T) \,\stackrel{\mathrm{def}}{:=}\,
         \left\{ \begin{array}{l}
           T_2 \quad \text{\it if}\;\; T = \bot \vee T_2  \\
           T_{12} \quad \text{\it if}\;\; T = (\bot \vee T_{12}) \vee
            T_2\ \text{\it s.t.}\ \mathpzc{id}(T) = \mathpzc{id}(\bot \vee
             T_{12})  \\
           \mathpzc{Tl}_{\langle\rangle}(T_{11} \vee T_{12})
            \quad \!\!\begin{array}[t]{l}
              \text{\it if}\;\; T = (T_{11} \vee T_{12}) \vee T_2,\;
               T_{11} \neq \bot  \\
              \text{\it s.t.}\
  ...
  \begin{displaymath}
    \begin{array}{c}
        ...
        \dfrac{
          \begin{array}{c}
            \Lambda_1 \vdash T_1 \>\dot{\blacktriangleright}\> \mathcal{R}_1
             \quad \Lambda_2 \vdash T_2 \>\dot{\blacktriangleright}\>
              \mathcal{R}_2 \quad \text{\it s.t.}\
               \mathpzc{Dom}(\Lambda_1) \cap \mathpzc{Dom}(\Lambda_2)
                = \phi \\
            \text{\it where}\ T \>\dot{\cong}\> T_1 \wedge T_2 \
             \text{\it s.t.} \!\begin{array}[t]{l}
               \mathpzc{id}(T_1 \wedge T_2) \neq \mathpzc{id}(T_1),\,
                \mathpzc{id}(T_2)  \\
               T,\, T_1 \!\wedge\! T_2 \not\in
          ...
          \Bigl\{\bigl(T, T_1 \wedge T_2,
           \mathcal{R}_1 \wedge \mathcal{R}_2, \wedge,
            (\Lambda_1 \cup \Lambda_2) \bigr) \Bigr\}
             \cup (\Lambda_1 \cup \Lambda_2) \vdash
              T \>\dot{\blacktriangleright}\> \mathcal{R}_1 \wedge
               \mathcal{R}_2
        }  &  (\text{\it T-Cas-nucls})
      \end{array}  \\
      \\
            ...
            \Lambda_1 \vdash T_1 \>\dot{\blacktriangleright}\> \mathcal{R}_1
             \quad \Lambda_2 \vdash T_2 \>\dot{\blacktriangleright}\>
              \mathcal{R}_2 \quad \text{\it s.t.}\
               \mathpzc{Dom}(\Lambda_1) \cap \mathpzc{Dom}(\Lambda_2)
                = \phi  \\
            \text{\it where}\ T \>\dot{\cong}\> T_1 \vee T_2\
             \text{\it s.t.} \!\begin{array}[t]{l}
               \mathpzc{id}(T_1 \vee T_2) \neq \mathpzc{id}(T_1),\,
                \mathpzc{id}(T_2)  \\
               T,\, T_1 \!\vee\! T_2 \not\in
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            \dfrac{}{T \in \mathcal{E}}
             \quad \genfrac{}{}{0pt}{0}{}{\mathcal{R}_1 \,\text{\it is}\,
              \text{\it Any}.}
          }{
            \bigl\{(T, \epsilon, {\mathcal{R}_1}^*, \text{\it nil}, \phi)
             \bigr\} \vdash T \>\dot{\blacktriangleright}\>
              {\mathcal{R}_1}^*
          }  &  (\text{\it nil}\,)  \\
          \\
          \dfrac{
            \Lambda' \vdash T' \>\dot{\blacktriangleright}\> \mathcal{R}_1\
             \text{\it where}\ T \cong T'\ \text{\it s.t.}\
              T \not\in \mathpzc{Dom}(\Lambda')
          }{
            \bigl\{(T, T', {\mathcal{R}_1}^*, \text{\it sol}, \Lambda' )
          ...
          \dfrac{
            \begin{array}{c}
              \Lambda_h \vdash T_h \>\dot{\blacktriangleright}\>
               \mathcal{R}_1 
    ...
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          ...
          \dfrac{
            \Lambda' \vdash T' \>\dot{\blacktriangleright}\> \mathcal{R}_1\
            \text{\it where}\ T \>\dot{\cong}\> T'\ \text{\it s.t.}\
             T \not\in \mathpzc{Dom}(\Lambda')
          }{
            \bigl\{(T, T', {\mathcal{R}_1}^?, \text{\it sol},
             \Lambda') \bigr\} \cup \Lambda' \vdash
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            \Lambda_L \vdash T' \>\dot{\blacktriangleright}\> \mathcal{R}_1\
             \text{\it where}\ T \>\dot{\cong}\> T'\ 
              \text{\it s.t.}\ T \not\in \mathpzc{Dom}(\Lambda_L)
               \quad \mathcal{R}_2 \,\text{\it is}\, \text{\it Any}.
          }{
            \bigl\{(T, T', \mathcal{R}_1|\mathcal{R}_2,
          ...
          \dfrac{
            \Lambda_L \not\vdash T' \>\dot{\blacktriangleright}\>
             \mathcal{R}_1
            \quad \Lambda_R \vdash T' \>\dot{\blacktriangleright}\>
             \mathcal{R}_2\ \text{\it where}\
              T \>\dot{\cong}\> T'\ \text{\it s.t.}\
               T \not\in \mathpzc{Dom}(\Lambda_R)
          }{
            \bigl\{(T, T', \mathcal{R}_1|\mathcal{R}_2,
             \text{\it R}, \Lambda_R) \bigr\} \cup \Lambda_R \vdash
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            \begin{array}{l}
              \Lambda_2 \vdash \epsilon \>\dot{\blacktriangleright}\>
               \mathcal{R}_2\ \text{\it s.t.}\
                \mathcal{R}_2 \,\text{\it is}\, \text{\it Any}.  \\
              \Lambda_1 \vdash T' \>\dot{\blacktriangleright}\>
               \mathcal{R}_1\ \text{\it where}\ T \>\dot{\cong}\> T'\
                \text{\it s.t.} \!\begin{array}[t]{l}
                  T,\, T' \!\wedge \epsilon \not\in
                   \mathpzc{Dom}(\Lambda_1 \cup \Lambda_2)  \\
                  \mathpzc{Dom}(\Lambda_1) \cap \mathpzc{Dom}(\Lambda_2)
            ...
            \biggl\{\Bigl(T, T' \!\wedge \epsilon,
              \mathcal{R}_1 \wedge \mathcal{R}_2, \wedge,
               (\Lambda_1 \cup \Lambda_2) \Bigr) \biggr\} \vdash T
                \>\dot{\blacktriangleright}\> \mathcal{R}_1 \wedge
                 \mathcal{R}_2
          }  &  (\text{\it L})  \\
          \\
          \dfrac{
            \begin{array}{l}
              \Lambda_1 \vdash \epsilon \>\dot{\blacktriangleright}\>
               \mathcal{R}_1\ \text{\it s.t.}\
                \mathcal{R}_1 \,\text{\it is}\, \text{\it Any}.  \\
              \Lambda_2 \vdash T' \>\dot{\blacktriangleright}\>
               \mathcal{R}_2\ \text{\it where}\ T \>\dot{\cong}\> T'\
                \text{\it s.t.} \!\begin{array}[t]{l}
                  T,\, \epsilon \wedge T' \not\in
                   \mathpzc{Dom}(\Lambda_1 \cup \Lambda_2)  \\
                  \mathpzc{Dom}(\Lambda_1) \cap \mathpzc{Dom}(\Lambda_2)
            ...
            \biggl\{\Bigl(T, \epsilon \wedge T',
              \mathcal{R}_1 \wedge \mathcal{R}_2, \wedge,
               (\Lambda_1 \cup \Lambda_2) \Bigr) \biggr\} \vdash T
                \>\dot{\blacktriangleright}\> \mathcal{R}_1 \wedge
                 \mathcal{R}_2
          }  &  (\text{\it R})
        \end{array} \right\}  &  \text{\it (T-Phony-Cas-nucls)}
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            ...
            \biggl\{\Bigl(T, T' \vee \epsilon,
             \mathcal{R}_1 \vee \mathcal{R}_2, \vee,
              (\Lambda_1 \cup \Lambda_2) \Bigr) \biggr\} \vdash T
               \>\dot{\blacktriangleright}\> \mathcal{R}_1 \vee
                \mathcal{R}_2
          }  &  (\text{\it L})  \\
          \\
          \dfrac{
            ...
            \biggl\{\Bigl(T, \epsilon \vee T',
             \mathcal{R}_1 \vee \mathcal{R}_2, \vee,
              (\Lambda_1 \cup \Lambda_2) \Bigr) \biggr\} \vdash T
               \>\dot{\blacktriangleright}\> \mathcal{R}_1 \vee
                \mathcal{R}_2 
          }  &  (\text{\it R})
        \end{array} \right\}  &  \text{\it (T-Phony-Par-nucls)}
      \end{array}
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            ...
            \bigl\{(T, T', \mathcal{R}_1, \wedge, \Lambda') \bigr\} \cup
             \Lambda' \vdash T \>\dot{\blacktriangleright}\> \mathcal{R}_1
          }  &  (\text{\it L})  \\
          \\
          \dfrac{
        ...
        \end{array} \right\}  &  \text{\it (T-Reveal-Cas-nucls)}
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \left. \begin{array}{rl}
          \dfrac{
            ...
            \bigl\{(T, T', \mathcal{R}_1, \vee, \Lambda') \bigr\} \cup
             \Lambda' \vdash T \>\dot{\blacktriangleright}\> \mathcal{R}_1
          }  &  (\text{\it L})  \\
          \\
          \dfrac{
        ...
        \end{array} \right\}  &  \text{\it (T-Reveal-Par-nucls)}
      \end{array}
