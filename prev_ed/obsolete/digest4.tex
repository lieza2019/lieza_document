...
\pagebreak
\begin{Definition}{内部表現項に関する型照合の拡張(汎照合:EXTENSIVE
  PATTERNMATCHING ON INTERNAL TERMS)}
  内部表現項$T$の, 型$\mathcal{R}$に対する型照合の定義を, 以下のように
  拡張する.
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \dfrac{
          \Delta_1 \leqq \Delta
           \quad \Delta_1 \vdash T \triangleright \mathcal{R}
        }{ \Delta \vdash T \triangleright \mathcal{R} }
        &  (\mbox{T-Nons-nucls})
      \end{array}
      ...
      & \begin{array}{rl}
        \dfrac{
          T_1 \wedge T_2 = T'
           \quad \Delta_1 \vdash T_1 \triangleright \mathcal{R}_1
            \quad \Delta_2 \vdash T_2 \triangleright \mathcal{R}_2
        }{
          \bigl\{(T',\mathcal{R}_1 \!\wedge\!
           \mathcal{R}_2) \bigr\} \cup (\Delta_1 \cup \Delta_2) \vdash
            T' \triangleright \mathcal{R}_1 \wedge \mathcal{R}_2
        }  &  (\mbox{T-Cas-nucls})
      \end{array}
      ...
      \begin{array}{rl}
        \dfrac{
          ...
          \bigl\{(T', \mathcal{R}_1 \!\vee\! \mathcal{R}_2)
           \bigr\} \cup (\Delta_1 \cup \Delta_2) \vdash
            T' \triangleright \mathcal{R}_1 \vee \mathcal{R}_2
        }  &  (\mbox{T-Para-nucls})
      \end{array}  \\
      ...
      \begin{array}{rl}
        \left.\begin{array}{c}
          \begin{array}{rl}
            \begin{array}{rl}
              \dfrac{
                \genfrac{}{}{0pt}{0}{}{T = \epsilon}
                \quad \dfrac{}{ \bigl\{(\epsilon, \mathcal{R}_1^*) \bigr\} 
                  \vdash \epsilon : \mathcal{R}_1^*
                }
              }{
                \bigl\{(T, \mathcal{R}_1^*) \bigr\} \vdash
                 T \triangleright \mathcal{R}_1^*
          ...
          \begin{array}{rl}
            \dfrac{
              \begin{array}{c}
                T_h \wedge T_t \neq \epsilon \quad T_h \wedge T_t = T'  \\
               \quad \Delta_h \vdash T_h \triangleright \mathcal{R}_1
                \quad \Delta_t \vdash T_t \triangleright \mathcal{R}_1^*
                 \quad (\Delta_h \cup \Delta_t) \vdash
                  T_h \wedge T_t \,\neg\, \mathcal{R}_1                
              \end{array}
            }{
              \bigl\{(T', \mathcal{R}_1^*) \bigr\} \cup
               (\Delta_h \cup \Delta_t) \vdash
                T' \triangleright \mathcal{R}_1^*
            }  &  (\beta)
          \end{array}
        \end{array} \right\}  &  (\mbox{T-Cat0-nucls})
      \end{array}  \\
      \\
      \begin{array}{rl}
        \left.\begin{array}{c}
          ...
          \end{array}
        \end{array} \right\}  &  (\mbox{T-Cat1-nucls})
      \end{array}  \\
      \\
        ...
        \left.\begin{array}{c}
          \begin{array}{rl}
            \dfrac{
              ...
              \bigl\{(T', \mathcal{R}_1^\downarrow) \bigr\} \cup \Delta
               \vdash T' \triangleright \mathcal{R}_1^\downarrow
            }  &  (\alpha)
          \end{array}  \\
          \\
          \begin{array}{rl}
            \dfrac{
              ...
              \bigl\{(T', \mathcal{R}_1^\downarrow) \bigr\}
               \cup (\Delta_h \cup \Delta_t) \vdash
                T' \triangleright \mathcal{R}_1^\downarrow
            }  &  (\beta)
          \end{array}
        \end{array} \right\}  &  (\mbox{T-Dup-nucls})
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \left.\begin{array}{c}
          ...
          \end{array}
        \end{array} \right\}  &  (\mbox{T-Opt-nucls})
      \end{array}  \\
      \\
      ...
      %\begin{array}{rl}
        \begin{array}{rl}
          \dfrac{
            ...
            \bigl\{(T, \mathcal{R}_0) \bigr\} \vdash
             T \triangleright \mathcal{R}_0
          }  &  (\mbox{T-Atom0-nucls})
        \end{array}  \\
        \\
        \begin{array}{rl}
          \dfrac{
            \genfrac{}{}{0pt}{0}{}{\mathcal{F}(t_1) = T}
            \quad \dfrac{
              \dfrac{}{
                (t_1, \mathcal{R}_1) \in \Gamma_1
              }
...
\begin{Definition}{準同値性(RESTRICTED EQUIVALENCE ON INTERNAL TERMS)}
\label{restricted_equality}
  $T$において, 以下の関係$\doteq$が成立する.
  \begin{displaymath}
    \begin{array}{c}
      
      \begin{array}{cl}
        (\text{\it Identity-impl})  &  T \doteq T
      \end{array}  \\
      
      \begin{array}{cl}
        (\text{\it Associativity-Cas-impl})
        & T_1 \bowtie_\wedge \cdots \bowtie_\wedge T_n \doteq
           T_1 \bowtie'_\wedge \cdots \bowtie'_\wedge T_n,\
            \text{\it s.t.}\ T_j \not\equiv T_{j1} \wedge T_{j2}  \\
        (\text{\it Associativity-Para-impl})
        & T_1 \bowtie_\vee \cdots \bowtie_\vee T_n \doteq
           T_1 \bowtie'_\vee \cdots \bowtie'_\vee T_n,\
            \text{\it s.t.}\ T_j \not\equiv T_{j1} \vee T_{j2}  \\
      \end{array}  \\
      
      \begin{array}{cc}
        \begin{array}{cl}
          (\text{\it StripH-Cas-impl})  &  \epsilon \wedge T \doteq T
        \end{array}
        & \begin{array}{cl}
            (\text{\it StripT-Cas-impl})  &  T \wedge \epsilon \doteq T
          \end{array}
      \end{array}  \\
      \begin{array}{cc}
        \begin{array}{cl}
          (\text{\it StripH-Para-impl})  &  \epsilon \vee T \doteq T
        \end{array}
        & \begin{array}{cl}
            (\text{\it StripT-Para-impl})  &  T \vee \epsilon \doteq T
          \end{array}
      \end{array}  \\
      
      \begin{array}{cc}
        \begin{array}{cl}
          (\text{\it PhonyH-Cas-impl})  &  T \doteq \epsilon \wedge T
        \end{array}
        & \begin{array}{cl}
            (\text{\it PhonyT-Cas-impl})  &  T \doteq T \wedge \epsilon
          \end{array}
      \end{array}  \\
      \begin{array}{cc}
        \begin{array}{cl}
          (\text{\it PhonyH-Para-impl})  &  T \doteq \epsilon \vee T
        \end{array}
        & \begin{array}{cl}
            (\text{\it PhonyT-Para-impl})  &  T \doteq T \vee \epsilon
          \end{array}
      \end{array}
...
\begin{Corollary} \label{termsize_invariant}
  \[ T \doteq T' \;\text{\it by}\ (\text{\it Associativity-Cas-impl})
      \>\Rightarrow\> \mathpzc{Size}(T) = \mathpzc{Size}(T')
  \]
  \begin{Proof}
  \end{Proof}
\end{Corollary}
...
\begin{Property}{soundness on equivalence} \label{soundness_on_equiv}
  \[ T \doteq T' \>\Rightarrow\> T = T'
  \]
  \begin{Proof}
  \end{Proof}
\end{Property}
...
\newpage
\begin{Definition}{制限された型照合規則(RESTRICTED PATTERNMATCHING RULES)}
\label{restricted_inference_rules}
  制限された型照合($\Lambda \>\dot{\vdash}\> T \>\dot{\triangleright}\>
  \mathcal{R}$)規則(RESTRICTED PATTERNMATCHING RULES)を以下のように定義する.
  \begin{displaymath}
    \begin{array}{c}
      \begin{array}{rl}
        \dfrac{
          T_1 \wedge T_2 \doteq T'_1 \wedge T'_2
          \quad \Lambda_1 \>\dot{\vdash}\> T_1 \>\dot{\triangleright}\> \mathcal{R}_1
          \quad \Lambda_2 \>\dot{\vdash}\> T_2 \>\dot{\triangleright}\> \mathcal{R}_2
        }{
          \bigl\{(T'_1 \!\wedge\! T'_2, \mathcal{R}_1 \!\wedge\!
          \mathcal{R}_2) \bigr\} \cup (\Lambda_1 \cup \Lambda_2) 
          \>\dot{\vdash}\>
          T'_1 \wedge T'_2 \>\dot{\triangleright}\> \mathcal{R}_1 \wedge \mathcal{R}_2
        }  &  (\mbox{T-Cas-impl})
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_1 \vee T_2 \doteq T'_1 \vee T'_2
          \quad \Lambda_1 \>\dot{\vdash}\> T_1 \>\dot{\triangleright}\> \mathcal{R}_1
          \quad \Lambda_2 \>\dot{\vdash}\> T_2 \>\dot{\triangleright}\> \mathcal{R}_2
        }{
          \bigl\{(T'_1 \!\vee\! T'_2, \mathcal{R}_1 \!\vee\! \mathcal{R}_2)
          \bigr\} \cup (\Lambda_1 \cup \Lambda_2)
          \>\dot{\vdash}\>
          T'_1 \vee T'_2 \>\dot{\triangleright}\> \mathcal{R}_1 \vee \mathcal{R}_2
        }  &  (\mbox{T-Para-impl})
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \left.\begin{array}{c}
          \begin{array}{rl}
            \begin{array}{rl}
              \dfrac{
                ...
                \bigl\{(\epsilon, \mathcal{R}_1^*) \bigr\} \>\dot{\vdash}\>
                \epsilon \>\dot{\triangleright}\> \mathcal{R}_1^*
              }  &  (\epsilon)
            \end{array}
            & \begin{array}{rl}
                \dfrac{
                  T \!\not\equiv \epsilon
                  \quad \Lambda \>\dot{\vdash}\> T \>\dot{\triangleright}\> \mathcal{R}_1
                }{
                  \{(T, \mathcal{R}_1^*) \} \cup \Lambda \>\dot{\vdash}\>
                  T \>\dot{\triangleright}\> \mathcal{R}_1^*
                }  &  (\alpha)  \\
              \end{array}
          \end{array}  \\
          \\
          \begin{array}{rl}
            \dfrac{
              \begin{array}{c}
                T_h \wedge T_t \doteq T'_h \wedge T'_t
                 \quad \mathpzc{Size}(T_h \wedge T_t) \le
                  \mathpzc{Size}(T'_h \wedge T'_t)  \\
                 \Lambda_h \>\dot{\vdash}\> T_h
                  \>\dot{\triangleright}\> \mathcal{R}_1
                   \quad \Lambda_t \>\dot{\vdash}\> T_t
                    \>\dot{\triangleright}\> \mathcal{R}_1^*
                     \quad (\Lambda_h \cup \Lambda_t) \>\dot{\vdash}\>
                      T'_h \wedge T'_t \,\dot{\neg}\, \mathcal{R}_1
              \end{array}
            }{
              \bigl\{(T'_h \!\wedge\! T'_t, \mathcal{R}_1^*) \bigr\} \cup
              (\Lambda_h \cup \Lambda_t) \>\dot{\vdash}\>
              T'_h \wedge T'_t \>\dot{\triangleright}\> \mathcal{R}_1^*
            }  &  (\beta)
          \end{array}
        \end{array} \right\}  &  (\mbox{T-Cat0-impl})
      \end{array}  \\
      \\
      \begin{array}{rl}
          \left.\begin{array}{c}
            \begin{array}{rl}
              \dfrac{
                \Lambda \>\dot{\vdash}\> T \>\dot{\triangleright}\> \mathcal{R}_1
              }{
                \bigl\{(T, \mathcal{R}_1^+) \bigr\} \cup \Lambda \>\dot{\vdash}\>
                T \>\dot{\triangleright}\> \mathcal{R}_1^+
              }  &  (\alpha)
            \end{array}  \\
            \\
            \begin{array}{rl}
              \dfrac{
                \begin{array}{c}
                  ...
                  \quad \mathpzc{Size}(T_h \wedge T_t) \le
                  \mathpzc{Size}(T'_h \wedge T'_t)  \\
                  \Lambda_h \>\dot{\vdash}\> T_h \>\dot{\triangleright}\>
                  \mathcal{R}_1
                  \quad \Lambda_t \>\dot{\vdash}\> T_t
                  \>\dot{\triangleright}\> \mathcal{R}_1^+
                  \quad (\Lambda_h \cup \Lambda_t) \>\dot{\vdash}\>
            ...
            \end{array}
          \end{array} \right\}  &  (\mbox{T-Cat1-impl})
      \end{array}  \\
      \\
        ...
        \left.\begin{array}{c}
          \begin{array}{rl}
            \dfrac{
              ...
              \bigl\{(T, \mathcal{R}_1^\downarrow) \bigr\} \cup
              \Lambda \>\dot{\vdash}\>
              T \>\dot{\triangleright}\> \mathcal{R}_1^\downarrow
            }  &  (\alpha)
          \end{array}  \\
          \\
          \begin{array}{rl}
            \dfrac{
              \begin{array}{c}
                T_h \vee T_t \doteq T'_h \vee T'_t
                \quad \mathpzc{Size}(T_h \vee T_t) \le
                \mathpzc{Size}(T'_h \vee T'_t)  \\
                \quad \Lambda_h \>\dot{\vdash}\> T_h \>\dot{\triangleright}\>
                \mathcal{R}_1
                \quad \Lambda_t \>\dot{\vdash}\> T_t
                \>\dot{\triangleright}\> \mathcal{R}_1^\downarrow
                \quad (\Lambda_h \cup \Lambda_t) \>\dot{\vdash}\>
                T'_h \vee T'_t \,\dot{\neg}\, \mathcal{R}_1
              \end{array}
            }{
              \bigl\{(T'_h \!\vee\! T'_t, \mathcal{R}_1^\downarrow) \bigr\}
              \cup (\Lambda_h \cup \Lambda_t) \>\dot{\vdash}\>
              T'_h \vee T'_t \>\dot{\triangleright}\> \mathcal{R}_1^\downarrow
            }  &  (\beta)
          \end{array}
        \end{array} \right\}  &  (\mbox{T-Dup-impl})
      \end{array}  \\
      \\
      ...
      \left.\begin{array}{c}
        ...
        \begin{array}{rl}
          \dfrac{
            T \!\not\equiv\! \epsilon \quad \Lambda \>\dot{\vdash}\>
             T \>\dot{\triangleright}\> \mathcal{R}_1
          }{
            \bigl\{(T, \mathcal{R}_1?) \bigr\} \cup \Lambda \>\dot{\vdash}\>
             T \>\dot{\triangleright}\> \mathcal{R}_1?
        ...
        \end{array}
      \end{array} \right\}  &  (\mbox{T-Opt-impl})
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \begin{array}{rl}
          \dfrac{
            ...
            \quad \dfrac{
              \dfrac{}{
                (T_0, \mathcal{R}) \in \Gamma_0
                 %\quad \mathcal{R} \in \text{\it Base}
              }
            }{
              \bigl\{(T_0, \mathcal{R}) \bigr\} \vdash T_0 : \mathcal{R}
            }
          }{
            \bigl\{(T, \mathcal{R}) \bigr\} \>\dot{\vdash}\>
             T \>\dot{\triangleright}\> \mathcal{R}
          }  &  (\mbox{T-Atom0-impl})
        \end{array}
        ...
        & \begin{array}{rl}
          \dfrac{
            ...
            \quad \dfrac{
              \dfrac{}{
                (T_1, \mathcal{R}) \in \Gamma_1
                 %\quad \mathcal{R} \not\in \text{\it Base}
              }
            }{
              \bigl\{(T_1, \mathcal{R}) \bigr\} \vdash T_1 : \mathcal{R}
            }
          }{
            \bigl\{(T, \mathcal{R}) \bigr\} \>\dot{\vdash}\>
             T \>\dot{\triangleright}\> \mathcal{R}
...
\begin{Property}{completeness on restricted matching}
\label{prop_of_restricted_patternmatch}
  \[ \Lambda \>\dot{\vdash}\> T \;\dot{\triangleright}\; \mathcal{R}
      \,\Rightarrow\, \Lambda \vdash T \triangleright \mathcal{R}
  \]
  \begin{Proof}
    Proof is simple induction on derivation for
    $\Lambda \>\dot{\vdash}\> T \;\dot{\triangleright}\; \mathcal{R}$,
    with Property \ref{soundness_on_equiv}.
    $\Box$
  \end{Proof}
\end{Property}


\begin{Definition}{$\mbox{漸照合}^*$($\mbox{INCREMENTAL MATCHING}^*$)}
  \label{incremental_matching_star}
  PATTERN $\mathcal{R} \equiv \mathcal{R}_1^*$に対する漸照合(POLYMORPHIC
  MATCHING SCHEME) $\mathcal{M}(T, \mathcal{R}_1^*)$を以下のように定義する.
  \begin{displaymath}
    \begin{array}{rll}
      \mathcal{M}(\mathcal{C}_{const}, \mathcal{R}_1^*) &:=
      & \left[ \begin{array}{ll}
          \Bigl(T_r', \bigl[(T_r', \mathcal{R}_1^*) \bigr] @ \mathcal{S}'
           \Bigr)
          & \text{\it if}\;\; \mathcal{S}' \neq \bot,\
             \text{\it where}\ (T'_r, \mathcal{S}') = \mathcal{M}(
              \mathcal{C}_{const}, \mathcal{R}_1).  \\ [5pt]
          (\mathcal{C}_{const}, \bot)  &  \text{\it otherwise}
        \end{array} \right. \\ [31pt]
      
      \mathcal{M}(\mathcal{C}_{ident}, \mathcal{R}_1^*) &:=
      & \left[ \begin{array}{ll}
          \Bigl(T_r', \bigl[(T_r', \mathcal{R}_1^*) \bigr] @ \mathcal{S}'
           \Bigr)
          & \text{\it if}\;\; \mathcal{S}' \neq \bot,\
             \text{\it where}\ (T'_r, \mathcal{S}') = \mathcal{M}(
              \mathcal{C}_{ident}, \mathcal{R}_1).  \\ [5pt]
          (\mathcal{C}_{ident}, \bot)  &  \text{\it otherwise}
        \end{array} \right.  \\ [31pt]
      
      \mathcal{M}(T_1 \wedge T_2, \mathcal{R}_1^*)  &:=
      & \left[ \begin{array}{ll}
          \multicolumn{2}{l}{
            \!\!\! \begin{array}{ll}
              \Bigl(\epsilon, \bigl[(\epsilon, \mathcal{R}_1^*) \bigr] \Bigr)
              & \text{\it if}\;\; \mathcal{S}' \neq \bot, \
                 \text{\it where}\ (\epsilon, \mathcal{S}') = \mathcal{M}(
                  T_1 \wedge T_2, \mathcal{R}_1).  \\ [7pt]
              
              \Bigl(T_r', \bigl[(T_r', \mathcal{R}_1^*) \bigr] @
               \mathcal{S}' \Bigr)
              & \text{\it if}\;\; T'_r \not\equiv \epsilon,\,
                 \mathcal{S}' \neq \bot, \
                  \text{\it where}\ (T'_r, \mathcal{S}') =
                   \mathcal{M}(T_1 \wedge T_2, \mathcal{R}_1).
            \end{array}  
          }  \\ [5pt]
          
          \Bigl(T'_{1r} \!\wedge\! T'_{2r}, \bigl[(T'_{1r} \!\wedge\!
           T'_{2r}, \mathcal{R}_1^*) \bigr] @ (\mathcal{S}'_1 @
            \mathcal{S}'_2) \Bigr)
          & \text{\it if}\; \left\{\begin{array}{l}
              \!\! (T'_{1r}, \mathcal{S}'_1 ) \!=\! \mathcal{M}(
               T_1 ,\mathcal{R}_1),\; \mathcal{S}'_1 \!\neq\! \bot  \\
              \!\! (T'_{2r}, \mathcal{S}'_2 ) \!=\! \mathcal{M}(
               T_2, \mathcal{R}_1^*),\; \mathcal{S}'_2 \!\neq\! \bot
            \end{array} \right.  \\ [15pt]
          
          \Bigl(T'_{21r} \!\wedge\! T'_{22r}, \bigl[(T'_{21r} \!\wedge\!
           T'_{22r}, \mathcal{R}_1^*) \bigr] @ (\mathcal{S}'_1 @
            \mathcal{S}'_2) \Bigr)
          & \text{\it if}\; \left\{\begin{array}{l}
              \!\! (T'_{21r}, \mathcal{S}'_1 ) \!=\! \mathcal{M}(
               T_{21},\mathcal{R}_1),\; \mathcal{S}'_1 \!\neq\! \bot  \\
              \!\! (T'_{22r}, \mathcal{S}'_2 ) \!=\! \mathcal{M}(
               T_{22}, \mathcal{R}_1^*),\; \mathcal{S}'_2 \!\neq\! \bot
            \end{array} \right.  \\
          \multicolumn{2}{l}{
            \quad ,\text{where}\ T_1 \equiv \epsilon,\;
             T_2 \equiv T_{21} \wedge T_{22}
          }  \\
          
          \Bigl(T'_{11r} \!\wedge\! T'_{12r}, \bigl[(T'_{11r} \!\wedge\!
           T'_{12r}, \mathcal{R}_1^*) \bigr] @ (\mathcal{S}'_1 @
            \mathcal{S}'_2) \Bigr)
          & \text{\it if}\; \left\{\begin{array}{l}
              \!\! (T'_{11r}, \mathcal{S}'_1 ) \!=\! \mathcal{M}(
               T_{11},\mathcal{R}_1),\; \mathcal{S}'_1 \!\neq\! \bot  \\
              \!\! (T'_{12r}, \mathcal{S}'_2 ) \!=\! \mathcal{M}(
               T_{12}, \mathcal{R}_1^*),\; \mathcal{S}'_2 \!\neq\! \bot
            \end{array} \right.  \\
          \multicolumn{2}{l}{
            \quad ,\text{where}\ T_1 \equiv T_{11} \wedge T_{12},\;
             T_2 \equiv \epsilon
          }  \\
          ...
          & \text{\it if}\; \left\{\begin{array}{l}
              \!\! (T''_{1r}, \mathcal{S}'_1 ) \!=\! \mathcal{M}(
               T'_1,\mathcal{R}_1),\; \mathcal{S}'_1 \!\neq\! \bot  \\
              \!\! (T''_{2r}, \mathcal{S}'_2 ) \!=\! \mathcal{M}(
               T'_2, \mathcal{R}_1^*),\; \mathcal{S}'_2 \!\neq\! \bot
            \end{array} \right.  \\
          \multicolumn{2}{l}{
            \quad ,\text{where}\ \exists T'_1, \exists T'_2\
             \text{\it satisfy}\ T'_1 \wedge T'_2 \doteq T_1 \wedge T_2,\
              \text{\it by}\; (\text{\it Associativity-Cas-minor}).
          }  \\ [3pt]
          
          (T_1 \wedge T_2, \bot)  &  \text{\it otherwize}
        \end{array} \right.  \\ [125pt]
        
        \mathcal{M}(T_1 \vee T_2, \mathcal{R}_1^*) &:=
        & \left[ \begin{array}{ll}
            \Bigl(\epsilon, \bigl[(\epsilon, \mathcal{R}_1^*) \bigr] \Bigr)
            & \text{\it if}\;\; \mathcal{S}' \neq \bot, \
               \text{\it where}\ (\epsilon, \mathcal{S}') = \mathcal{M}(
                T_1 \vee T_2, \mathcal{R}_1).  \\ [7pt]
            \Bigl(T_r', \bigl[(T_r', \mathcal{R}_1^*) \bigr] @ \mathcal{S}'
             \Bigr)
            & \text{\it if}\;\; T'_r \not\equiv \epsilon,\,
               \mathcal{S}' \neq \bot, \
                \text{\it where}\ (T'_r, \mathcal{S}') =
                 \mathcal{M}(T_1 \vee T_2, \mathcal{R}_1).  \\ [5pt]
            (T_1 \vee T_2, \bot)  &  \text{\it otherwise}
          \end{array} \right. \\ [39pt]
        
        \mathcal{M}(\epsilon, \mathcal{R}_1^*) &:=
        & \left[ \begin{array}{ll}
            \bigl(\epsilon, \mathpzc{m}(\epsilon, \mathcal{R}_1^*) \bigr)
            & \text{\it if}\;\; \mathpzc{m}(\epsilon, \mathcal{R}_1^*) \neq
               \bot  \\ [1pt]
            (\epsilon, \bot)  &  \text{\it otherwise}
          \end{array} \right.
...
\begin{Lemma}{$\mbox{matching soundness}^*$}
\label{matching_soundness_for_cat0}
  \[ \mathcal{S} \neq \bot \,\Rightarrow\,
      \mathcal{S} \>\dot{\vdash}\> T_r \>\dot{\triangleright}\>
       \mathcal{R}_1^* \;\,\text{\it s.t.}\; T_r = T,\ \text{\it where}\
        (T_r, \mathcal{S}) = \mathcal{M}(T, \mathcal{R}_1^*).
  \]
  \begin{Proof}
  \end{Proof}
\end{Lemma}
...
\begin{Lemma}{$\mbox{matching completeness}^*$}
\label{matching_completeness_for_cat0}
  \[ \Gamma \>\dot{\vdash}\> T \>\dot{\triangleright}\> \mathcal{R}_1^*
      \,\Rightarrow\, \mathcal{S} \>\dot{\vdash}\> T_r
       \>\dot{\triangleright}\> \mathcal{R}_1^* \;\,\text{\it s.t.}\;
        T_r = T,\ \text{\it where}\ (T_r, \mathcal{S}) =
         \mathcal{M}(T, \mathcal{R}_1^*).
  \]
  \begin{Proof}
  \end{Proof}
\end{Lemma}
