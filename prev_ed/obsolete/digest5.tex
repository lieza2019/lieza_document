  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{rl}
        \dfrac{
          T_1 \>\dot{\cong}\> T'_1 \quad T_2 \>\dot{\cong}\> T'_2 \
           \text{\it where}\ T = T_1 \wedge T_2,\ T' = T'_1 \wedge T'_2
        }{
          T \>\dot{\cong}\> T' \ \text{\it s.t.}\
           T'' \in T_1 \bowtie_\wedge \cdots \bowtie_\wedge T_n = T'
        }  &  (\text{\it AssociativeTransparency-Cas-nucls})
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \dfrac{
          T_1 \>\dot{\cong}\> T'_1 \quad T_2 \>\dot{\cong}\> T'_2 \
           \text{\it where}\ T = T_1 \vee T_2,\ T' = T'_1 \vee T'_2
        }{
          T \>\dot{\cong}\> T' \ \text{\it s.t.}\
           T'' \in T_1 \bowtie_\vee \cdots \bowtie_\vee T_n = T'
        }  &  (\text{\it AssociativeTransparency-Par-nucls})
      \end{array}  \\
      \\
      ...
      \begin{array}{rl}
        \left. \begin{array}{r}
          \dfrac{
            T \>\dot{\cong}\> T_1 \wedge \bot \ \text{\it where}\
             T_1 \neq \epsilon
          }{
            T \>\dot{\cong}\> T_1 \wedge (\epsilon \wedge \bot) \
             \text{\it s.t.} \! \begin{array}[t]{l}
               \mathpzc{id}(\epsilon \wedge \bot) =
                \mathpzc{id}(\epsilon) \\
               \mathpzc{id}\bigl(T_1 \wedge (\epsilon \wedge \bot) \bigr)
                \neq \mathpzc{id}(\epsilon \wedge \bot)
            \end{array}
          }  \\
          \\
          \dfrac{
            T \>\dot{\cong}\> T_1 \wedge T_2 \ \text{\it where}\
             T_2 = \exists T_{21} \wedge \exists T_{22} \ \text{\it s.t.}\
      ...
      \begin{array}{rl}
        \left.\begin{array}{r}
          \dfrac{
            T \>\dot{\cong}\> T_1 \wedge \bot
          }{
            T \>\dot{\cong}\> (\epsilon \wedge \bot) \wedge T_1 \
            \text{\it s.t.}\ \mathpzc{id}\bigl((\epsilon \wedge \bot) \wedge
             T_1 \bigr) \neq \mathpzc{id}(T_1)
          }  \\
          \\
          \dfrac{
            T \>\dot{\cong}\> T_1 \wedge T_2 \ \text{\it where}\
             T_2 = \exists T_{21} \wedge \bot \ \text{\it s.t.}\
              \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_2)
          }{
            T \>\dot{\cong}\> (T_1 \wedge \bot) \wedge T_{21}\
             \text{\it s.t.}\ \mathpzc{id}\bigl((T_1 \wedge \bot) \wedge
              T_{21} \bigr) \neq \mathpzc{id}(T_{21})
          }  \\
          \\
          \dfrac{
            T \>\dot{\cong}\> T_1 \wedge T_2\ \text{\it where}\
             T_2 = \exists T_{21} \wedge \exists T_{22}\ \text{\it s.t.}
              \!\begin{array}[t]{l}
               T_{22} \neq \bot, \,
                \mathpzc{id}(T_2) = \mathpzc{id}(T_{22})  \\
               \mathpzc{id}(T_1 \wedge T_2) = \mathpzc{id}(T_2)
              \end{array}
          }{
            T \>\dot{\cong}\> (T_1 \wedge T'_2) \wedge T_3
             \!\begin{array}[t]{rl}
               \text{\it where} &\!\!\! T'_2 = T_{21} \wedge
                \mathpzc{Hd}(T_{22}),\, T_3 = \mathpzc{Tl}(T_{22}) \\
               \text{\it s.t.} &\!\!\! \!\!\!\begin{array}[t]{l}
                 T_2 = \mathpzc{App}_{\{\}}\bigl(T'_2, T_3,
                  \mathpzc{id}(T_2) \bigr) \\
                 \mathpzc{id}(T'_2) = \mathpzc{id}\bigl(
                  \mathpzc{Hd}(T_{22}) \bigr),\, 
                   \mathpzc{id}(T_1 \wedge T'_2) = \mathpzc{id}(T'_2) \\
                 \mathpzc{id}(T_3) \!\neq\! \mathpzc{id}\bigl(
                  (T_1 \wedge T'_2) \wedge T_3 \bigr)
               \end{array}
             \end{array}
          }
        \end{array} \right\}
      ...
      \begin{array}{rl}
        \dfrac{
          \begin{array}{l}
            T \>\dot{\cong}\> (T_3 \wedge T_2) \wedge T_1\
             \text{\it where} \!\begin{array}[t]{l}
              T_3 = \bot\ \text{\it s.t.}\ \mathpzc{id}(T_3 \wedge T_2) =
               \mathpzc{id}\bigl((T_3 \wedge T_2) \wedge T_1 \bigr)  \\
                \mbox{或}\ T_3 \neq \bot\ \text{\it s.t.}
                  \!\begin{array}[t]{l}
                    \mathpzc{id}(T_3) = \mathpzc{id}(T_3 \wedge T_2)  \\
                    \mathpzc{id}(T_3 \wedge T_2) = \mathpzc{id}\bigl(
                     (T_3 \wedge T_2) \wedge T_1 \bigr)
                  \end{array}
             \end{array} \\
            T' = T_1 \wedge (T_3 \wedge T_2)\ \text{\it where}
             \!\begin{array}[t]{l}
               T_3 = \bot \\
               \mbox{或}\ T_3 \neq \bot\ \text{\it s.t.}\
                \mathpzc{id}(T_3) = \mathpzc{id}(T_3 \wedge T_2)
  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{l}
        ...
        \qquad \dfrac{
          \begin{array}{l}
            T \>\dot{\cong}\> T_2 \wedge T_1\
             \text{\it where} \!\begin{array}[t]{l}
               T_2 = \bot \wedge T_{21}\ \text{\it s.t.}\
                \mathpzc{id}(T_2) = \mathpzc{id}(T_2 \wedge T_1)  \\
               \mbox{或}\ T_2 = T_{22} \wedge T_{21},\ T_{22} \neq \bot\
                \text{\it s.t.} \!\begin{array}[t]{l}
                  \mathpzc{id}(T_{22}) = \mathpzc{id}(T_2)  \\
                  \mathpzc{id}(T_2) = \mathpzc{id}(T_2 \wedge T_1)
                \end{array}
             \end{array} \\
             T' = (T'_{22} \wedge T'_{21}) \wedge T_3\
             \text{\it where} \!\begin{array}[t]{l}
               T'_{22} = \bot,\ T'_{21} = T_1,\ T_3 = T_{21}  \\
               \mbox{或}\ T'_{22} \neq \bot,\ T'_{21} = T_1,\ 
                T_3 = \mathpzc{Tl}(T_2) \\
               \qquad \text{\it s.t.}\ \mathpzc{id}(T'_{22}) =
                \mathpzc{id}(T'_{22} \wedge T'_{21}),\
                 T_2 = \mathpzc{App}_{[]}\bigl(T'_{22}, T_3,
                  \mathpzc{id}(T_2) \bigr)
             \end{array}
          \end{array}
        }{
      ...
      \begin{array}{rl}
        \dfrac{
          \begin{array}{l}
            T \>\dot{\cong}\> (T_3 \vee T_2) \vee T_1\
             \text{\it where} \!\begin{array}[t]{l}
              T_3 = \bot\ \text{\it s.t.}\ \mathpzc{id}(T_3 \vee T_2) =
               \mathpzc{id}\bigl((T_3 \vee T_2) \vee T_1 \bigr)  \\
              \mbox{或}\ T_3 \neq \bot\ \text{\it s.t.}\
               \!\begin{array}[t]{l}
                 \mathpzc{id}(T_3) = \mathpzc{id}(T_3 \vee T_2)  \\
                 \mathpzc{id}(T_3 \vee T_2) = \mathpzc{id}\bigl(
                  (T_3 \vee T_2) \vee T_1 \bigr)
               \end{array}
             \end{array} \\
            T' = T_1 \vee (T_3 \vee T_2)\ \text{\it where}
             \!\begin{array}[t]{l}
               T_3 = \bot \\
               \mbox{或}\ T_3 \neq \bot\ \text{\it s.t.}\
                \mathpzc{id}(T_3) = \mathpzc{id}(T_3 \vee T_2)
      ...
      \begin{array}{l}
       \text{\it (UnlkT-Dup}_\infty\text{\it -nucls):}  \\
        \qquad \dfrac{
          \begin{array}{l}
            T \>\dot{\cong}\> T_2 \vee T_1\
             \text{\it where} \!\begin{array}[t]{l}
               T_2 = \bot \vee T_{21}\ \text{\it s.t.}\
                \mathpzc{id}(T_2) = \mathpzc{id}(T_2 \vee T_1)  \\
               \mbox{或}\ T_2 = T_{22} \vee T_{21},\
                T_{22} \neq \bot\ \text{\it s.t.} \!\begin{array}[t]{l}
                  \mathpzc{id}(T_{22}) = \mathpzc{id}(T_2) \\
                  \mathpzc{id}(T_2) = \mathpzc{id}(T_2 \vee T_1)
                \end{array}
             \end{array} \\
            T' = (T'_{22} \vee T'_{21}) \vee T_3\
             \text{\it where} \!\begin{array}[t]{l}
               T'_{22} = \bot,\ T'_{21} = T_1,\ T_3 = T_{21} \\
               \mbox{或}\ T'_{22} \neq \bot,\ T'_{21} = T_1,\
                T_3 = \mathpzc{Tl}(T_2) \\
               \qquad \text{\it s.t.} \!\begin{array}[t]{l}
                 \mathpzc{id}(T'_{22}) =
                  \mathpzc{id}(T'_{22} \vee T'_{21}),\
                 T_2 = \mathpzc{App}_{[]}\bigl(T'_{22}, T_3,
                  \mathpzc{id}(T_2) \bigr)
               \end{array}  \\
             \end{array}
