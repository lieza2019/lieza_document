              ...
              \Delta_h \vdash t_h \triangleright \mathcal{R}_1
               \quad \Delta_t \vdash t_t \triangleright {\mathcal{R}_1}^+
                \quad \mathpzc{Dom}(\Delta_h) \cap \mathpzc{Dom}(\Delta_t)
                 = \phi  \\
              t \simeq t_h \wedge t_t\ \text{\it s.t.}\
               \{t,\, t_h \wedge t_t' \} \cap \mathpzc{Dom}(
                \Delta_h \cup \Delta_t) = \phi
            \end{array}
          }{
            \begin{array}{r}
...
\begin{Lemma}{completeness on extended matching.}
  ...
  \begin{Proof}
    ...
    \mathcal{R}_1$ from
    Lemma \ref{consistency_on_domain_independency} and induction hypothesis
    applied on
...
\begin{Claim}
  \[ \text{\it if}\ t' \in \mathpzc{Dom}(\Delta)\ \text{\it s.t.}\
    ...
    \begin{Proof}
      ...
      hypothesis. Counterpart fragments to be considerd on
      ...
      $t' \in \mathpzc{Dom}(\Delta'_t)$ by induction hypothesis for
      $\mathpzc{size}(\mathcal{R}_1) < \mathpzc{size}({\mathcal{R}_1}^*)$.
      ...
      as desired by induction hypothesis.
      $\Box$
    \end{Proof}
\end{Claim}
...
\begin{Claim}
  ...
  \begin{Proof}
    ...
    of (T-Cat0-canon-$\infty$). By applying induction hypothesis on
    ...
    \Delta'_{t_t}$. Then we can apply induction hypothesis on
    $\Delta_t \vdash t_{\text{\it equ}_t} \triangleright {\mathcal{R}_1}^*$,
    ...
    from induction hypothesis as above. Therefore, from the fact we found
    above that
    ...
    applying induction hypothesis on
    $\Delta_{t_h} \vdash t_{\text{\it equ}_{t_h}} \triangleright
    \mathcal{R}_1$, with
