...
\pagebreak
\begin{Definition}[Term transducer]
  We define the term transducer $\mathcal{M}$ as follow, which sustains
  equality over transducing, see Property \ref{equality_over_transduction}.
  \begin{displaymath}
    \begin{array}{l}
...
machine using Caml, which is one of the most well-known implementation of
ML developped in INRIA France.
  ...
  \begin{displaymath}
    \begin{array}{c}
      ...
      \begin{array}{ll}
        ...
        & t_1 \wedge [t_2, \cdots t_n] \in
        \mathpzc{Equ}\bigl([t_1, t_2, \cdots t_n] \bigr)  \\
        & t_1 \wedge \langle t_2, \cdots t_n \rangle \in
