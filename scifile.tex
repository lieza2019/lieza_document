...
\begin{Lemma}{soundness on extended matching}
  ...
  \begin{Proof}
    ...
    $j = 1$ and $j \ge 2$.
    $(j = 1)$: For first case, we can derive $\{t_1\} \simeq t_1$ with
    ...
    $\{t_2\} \simeq t_2$ from $(\text{\it Associativity-Cat0}_1)$, with
    the condition of
    ...
    explained in Claim \ref{claim_for_soundness_on_extended_matching}, where
    ...
    Next we think of the case of $j > 2$. In this case  we suppose the
    situation of
...
Signal Controlling Circuit, and we also know which can be expressed
generally as
